 ...
 *
 */
public class ItemSapphirePickaxe extends ItemPickaxe implements IAutoSmelt, IBlueFireWeapon
{
    public ItemSapphirePickaxe(@Nonnull ToolMaterial material) { super(material); }
