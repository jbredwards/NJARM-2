...
public final class ConfigHandler
{
    ...
    @Nonnull public static final EntityConfig entityCfg = register(new EntityConfig(
            ...
            new MoobloomConfig(-1, -1, true, true,
                    ...
                    new String[] {
                            ...
                            "{Name:red_flower,Properties:{type:blue_orchid}}",
    ...
    @Nonnull public static final WorldConfig worldCfg = register(new WorldConfig(
            new OreConfig(new String[] {
                    ...
                    "{Ore:{Name:\"njarm:gravel_gold_ore\"},Stone:{Name:gravel},MinY:0,MaxY:256,ClumpSize:8,PerChunk:15,BiomeTags:[all],ExcludeBiomes:{BiomeTags:[beach,water]}}",
                    "{Ore:{Name:\"njarm:gravel_iron_ore\"},Stone:{Name:gravel},MinY:0,MaxY:256,ClumpSize:8,PerChunk:15,BiomeTags:[all],ExcludeBiomes:{BiomeTags:[beach,water]}}",
                    "{Ore:{Name:\"njarm:gravel_xp_ore\"},Stone:{Name:gravel},MinY:0,MaxY:256,ClumpSize:8,PerChunk:15,BiomeTags:[all],ExcludeBiomes:{BiomeTags:[beach,water]}}",
                    "{Ore:{Name:\"njarm:gravel_quartz_ore\"},Stone:{Name:gravel},MinY:0,MaxY:256,ClumpSize:14,PerChunk:15,BiomeTags:[all],ExcludeBiomes:{BiomeTags:[beach,water]}}",
