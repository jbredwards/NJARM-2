 ...
 *
 */
public class ItemSapphireSpade extends ItemSpade implements IAutoSmelt, IBlueFireWeapon
{
    public ItemSapphireSpade(@Nonnull ToolMaterial material) { super(material); }
