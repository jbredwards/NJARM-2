 ...
 *
 */
public class ItemSapphireSword extends ItemSword implements IAutoSmelt, IBlueFireWeapon
{
    public ItemSapphireSword(@Nonnull ToolMaterial material) { super(material); }
