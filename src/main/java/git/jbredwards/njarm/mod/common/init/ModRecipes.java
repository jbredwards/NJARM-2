...
public final class ModRecipes
{
    ...
    static void registerCrafting(@Nonnull IForgeRegistry<IRecipe> registry) {
        ...
        registerCrafting(registry, shaped(1, ModItems.MAGIC_SPONGE, "DSD", "WNW", "DSD", 'D', "dustMagicNJARM", 'S', new ItemStack(Blocks.SPONGE, 1, 0), 'W', new ItemStack(Blocks.SPONGE, 1, 1), 'N', "netherStar"));
