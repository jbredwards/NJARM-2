...
{
    /**
     * plays a sound as an entity from the server for all players in the area
     */
    ...
    /**
     * plays a sound from the server for all players in the area
     */
    ...
    public static void playServerSound(@Nonnull World world, double x, double y, double z, @Nonnull SoundEvent sound, @Nonnull SoundCategory category, float volume, float pitch) {
        if(world.getMinecraftServer() != null) world.getMinecraftServer().getPlayerList()
